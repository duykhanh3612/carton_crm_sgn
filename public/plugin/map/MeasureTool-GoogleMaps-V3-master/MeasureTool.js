  ...
  _createClass(MeasureTool, [{
    ...
    value: function _init() {
      if (this._options.contextMenu) {
        ...
        this._startElementNode = this._contextMenu.addItem("Đo diện tích", true, this.start, this);
        this._endElementNode = this._contextMenu.addItem("Xóa đo diện tích", false, this.end, this);
    ...
    value: function _updateArea(i, pointToCompare) {
      ...
      this._area = area;
      if (area > 0) {
          this._nodeText.select(':last-child').text('Tổng khoảng cách: ' + this.lengthText + '; Diện tích: ' + this.areaText + '.');
      }
    }
  }, {
