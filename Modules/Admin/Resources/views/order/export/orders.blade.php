        ...
        <tbody>
            ...
            <tr style="height: 19px">
                ...
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Ngày tạo</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Thu ngân</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Khách hàng</div>
                </td>
                <td class="s4">Địa chỉ</td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Điện thoại</div>
                </td>
                <td class="s4">Tổng SL</td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Tổng tiền hàng</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Giảm giá (trên phiếu)</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Tổng tiền</div>
                </td>
                <td class="s4">Tiền mặt</td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Chuyển khoản</div>
                </td>
                <td class="s4">Thẻ</td>
                <td class="s4">Còn nợ</td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Loại Đơn hàng</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Trạng thái</div>
                </td>
                <td class="s4">Ghi chú</td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Đơn vị giao hàng</div>
                </td>
                <td class="s4">Phí VC</td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Ngày giao</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Người giao</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Ghi chú vận chuyển</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Tên hàng hóa</div>
                </td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Mã hàng hóa</div>
                </td>
                <td class="s4">SL</td>
                <td class="s4">Giá bán</td>
                <td class="s4">Giảm giá</td>
                <td class="s4 softmerge">
                    <div class="softmerge-inner" style="left:-1px">Thành tiền</div>
                </td>
            ...
            <tr style="height: 19px">
                ...
                <td class="s1 softmerge">
                    <div class="softmerge-inner" style="left:-1px">{{$record->customer_phone}}</div>
                </td>
                ...
                <td class="s1 softmerge">
                    <div class="softmerge-inner" style="left:-1px">{{@$status[$record->status]}}</div>
                </td>
                <td class="s1 softmerge">
                    <div class="softmerge-inner" style="left:-1px"> {{@$status[$record->status]}}</div>
                </td>
                <td class="s1 softmerge">
                    <div class="softmerge-inner" style="left:-1px">{{$record->note}}</div>
                </td>
                ...
                <td class="s7 softmerge">
                    <div class="softmerge-inner" style="left:-1px">{{$record->description}}</div>
                </td>
                <td class="s1 softmerge">
                    <div class="softmerge-inner" style="left:-1px">{{$record->sku}}</div>
                </td>
