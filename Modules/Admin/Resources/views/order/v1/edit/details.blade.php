<div class="row">
    <div class="col-xs-12">
        <div class="table-responsive">
            <div class="barcode" data-ng-show="orderStatus < 2">
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="hidden-640">
                                    ...
                                    <div class="input-group ng-hide"
                                        data-ng-show="orderId == 0 || (saleTypeID > 1 &amp;&amp; orderStatus < 2 ) ">
                                        <input type="text" name="item[{{ $did }}][sku]"
                                            value="{{ $row->sku }}"
                                            class="form-control mousetrap ng-pristine ng-valid">
                                        <input type="text" name="item[{{ $did }}][product_id]"
                                ...
                                <td class="text-center">
                                    <div class="ace-spinner touch-spinner">
                                        <span class="ng-binding">{{ $row->qty }}</span>
                                        <div class="input-group ng-hide"
                                            data-ng-show="orderId == 0 || (saleTypeID > 1 &amp;&amp; orderStatus < 2 ) ">
                ...
                <tfoot style="display: none">
                    ...
                    <tr id="new_row_2" class="warning">
                        ...
                        <td class="hidden-480 text-right">
                            <div class="ng-binding">
                                <span class="item_price_label" style="display:none"></span>
                                <input type="text" class="item_price" class="form-control numeric spinner-input form-control mousetrap ng-pristine ng-valid" auto-numeric="isDecimal == true ? {vMin: 0, vMax: 9999999.9999,mDec: 4,aPad: false } :{vMin: 0, vMax: 9999999 } ">
