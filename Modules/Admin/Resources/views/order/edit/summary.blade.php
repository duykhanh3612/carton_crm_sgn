...
<div class="col-md-3 col-sm-6 col-12">
    <div class="info-box" id="box-discount">
        <span class="info-box-icon bg-success {{check_rights_function("discount_order",'read') && @$record->status <= 1?'showDiscount':''}}">
        ...
        <div class="info-box-content">
            ...
            <span class="info-box-number">
                ...
                @if(check_rights_function("discount_order",'read') && @$record->status <= 1)
