...
<div class="{{ $rowClass ?? 'form-group col-md-12' }}" @if (!empty($rowData)) @foreach ($rowData as $dataKey => $dataVal)
    ...
    <div class="">
        <div class="form-group">
            ...
            @endif
            <div class="input-group mb-3  money_widget" style="justify-content: space-between !important;flex-wrap: nowrap;">

                <input type="text" class="form-control input_money" value="{{ $value }}" id="<?= @$field ?>"  autocomplete="off">
