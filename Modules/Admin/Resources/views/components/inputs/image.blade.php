...
<div class="row {{ $rowClass ?? '' }}"
                ...
                <div class="fileinput fileinput-new" data-provides="fileinput" style="width: 100%;height:250px">
                    <div class="fileinput-new thumbnail" id="thumbnail_{{ $name }}">
                        @php
                            if (@$value != '') {
                                ...
                                $imagePath =  asset('img/370x250.jpg');
                            }
                        @endphp
                        <div class="preview-item">
                            <div class="mac-frame" style="height: 360px !important;">
                                <a title="arnormy furniture" target="_blank" href="{{ $link = @$r->website }}">
                                    <span class="image-wrap move-long"
                                        style="background-image:url('{{ @$imagePath }}')"></a>
                            </div>
                            <div class="iphone-frame" style="display:none !important;">
                    ...
                    <div id="button_{{ $name }}" style="display:flex;justify-content: center;">
                        ...
                        @else
                            ...
                            <a class="btn dark btn-clear-image{{ $name }}"
                                data-field="{{ $name }}" data-dismiss="fileinput">
                                {{ trans("remove") }}
                            </a>
                        @endif
    ...
    <script type="text/javascript" src="{{asset('public/plugin/jasny/jasny-bootstrap.min.js')}}" charset="UTF-8"></script>
    <script>
    $('.btn-clear-image{{$name}}').on('click',function(){
        ...
        $('#button_'+tag).html(' <input type="hidden" name="delete_image[{{ $name }}]" class="deleted" value="1" /><span class="btn btn-default btn-file"><span class="fileinput-new">Tải lên</span><span class="fileinput-exists">Tải lên</span><input type="file" name="{{$name}}" /> </span>');
    });
    </script>
    @endpush
</div>
