    ...
    $.fn.jConfirm = function(options) {
        ...
        let helper = {
            ...
            calculateSafePosition: function(position)
            {
                ...
                let top_elem = (parseInt(helper.dom_wrapped.parents(".popover ").css("top").replace("px",""))-20)+"px";
                let left_elem = (parseInt(helper.dom_wrapped.parents(".popover ").css("left").replace("px",""))+320)+"px";;
                return [arrow_dir, elem_width, tooltip_width, tooltip_height, left_elem,top_elem];
            },
