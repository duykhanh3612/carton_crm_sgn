...
LeftNavigation.prototype.updateLeftNavigation = async function () {
    ...
    this.root.find("[data-group]").each(function () {
        ...
        if(remove==true){
            updatemenuparentleft(1,sort_order,group_id,name,'approved_navigation');
        }
        if (remove == false) {
            updatemenuparentleft(0,sort_order,group_id,name,'approved_navigation');
        }
        ...
        $(this).find(".item").each(function () {
            ...
            if(del==true){
                updatemenuleft(1,sort_order,id,group_id,item_name,badge,url,'approved_navigation');
            }
            if (del == false) {
                updatemenuleft(0,sort_order,id,group_id,item_name,badge,url,'approved_navigation');
            }
