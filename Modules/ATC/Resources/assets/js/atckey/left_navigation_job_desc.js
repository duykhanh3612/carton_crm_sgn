...
LeftNavigation.prototype.setLeftHeaderFixedTable = function (el, animation = false) {
    ...
    $("#headertable").stickyTableHeaders({scrollableArea: $('.main_container')});
...
LeftNavigation.prototype.updateLeftNavigation = async function () {
    ...
    this.root.find("[data-group]").each(function () {
        ...
        if(remove==true){
            updatemenuparentleft(1,sort_order,group_id,name,'job_desc_navigation');
        }
        if (remove == false) {
            updatemenuparentleft(0,sort_order,group_id,name,'job_desc_navigation');
        }
        ...
        $(this).find(".item").each(function () {
            ...
            if(del==true){
                updatemenuleft(1,sort_order,id,group_id,item_name,badge,url,'job_desc_navigation');
            }
            if (del == false) {
                updatemenuleft(0,sort_order,id,group_id,item_name,badge,url,'job_desc_navigation');
            }
