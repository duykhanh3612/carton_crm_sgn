...
LeftNavigation.prototype.toggleSidebar = function () {
    ...
    $.cookie('closed-sidebar-pm', $('body').hasClass('closed-sidebar') ? 1 : 0, {
        path: '/'
    });
    this.visibleSidebar();
...
LeftNavigation.prototype.visibleSidebar = function () {
    var cookie_closed = $.cookie('closed-sidebar-pm');
    if (cookie_closed != "1") {
...
LeftNavigation.prototype.setLeftHeaderFixedTable = function (el, animation = false) {
    ...
    setTimeout(()=>{
        $('#table-filter').stickyTableHeaders({
...
LeftNavigation.prototype.updateLeftNavigation = async function () {
    ...
    //     if(remove==true){
    //         updatemenuparentleft(1,sort_order,group_id,name,'payment_management_navigation');
    //     }
    //     if (remove == false) {
    //         updatemenuparentleft(0,sort_order,group_id,name,'payment_management_navigation');
    //     }
    ...
    //         if(del==true){
    //             updatemenuleft(1,sort_order,id,group_id,item_name,badge,url,'payment_management_navigation');
    //         }
    //         if (del == false) {
    //             updatemenuleft(0,sort_order,id,group_id,item_name,badge,url,'payment_management_navigation');
    //         }
    //     })
    // })
...
LeftNavigation.prototype.updateBadges = async function () {
    ...
    var current_year = $.cookie('page_yearpayment_management');
