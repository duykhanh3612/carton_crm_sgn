                ...
                <tr class="highlight" id="{{ $key }}">
                    ...
                    <td class="field-value">
                        ...
                        @if (view()->exists("admin::components.input.$item->type" . @$mask))
                            {!! load_view("components.input.$item->type" . @$mask, (array)$item) !!}
                        @else
                            {!! load_view('components.input.text' . @$mask, (array)$item) !!}
                        @endif
                    </td>
                    <td>
                        <input type="text" name="name" value="{{ $valueName }}" class="form-control">
                    </td>
