    ...
    <div class="wrapper" id="loginPage">
        <div class="row">
                ...
                <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div style="flex-grow: 1" class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="margin-bottom: 1rem">
                            <img src="{{Themes::asset(user_setting("preloadingLogo"))}}" class="logo"  alt="Logo"  />
                        </div>
                        <form id="loginForm" action="{{route("admin.user.process_login")}}" class="w-100 d-flex flex-column" style="gap: 19px" method="POST"  >
                            <!-- tài khoản -->
                            <div class="form-group">
                                <label for="account" class="mb-1">Tài khoản</label>
                                <input type="text" class="form-control form-login" name="email" id="account" placeholder="Tên người dùng, sdt, email" onchange="" />
                                <p class="text-danger mt-1" id="accountWarning"></p>
                            </div>
                            <!-- mật khẩu -->
                            <div class="form-group">
                            ...
                            <div class="form-group d-flex justify-content-end align-items-center">
                                ...
                                <label for="rememberMe" class="ml-2">Nhớ mật khẩu</label>

                                <a href="{{url('admin/forget-password')}}">
                                    <label for="forgot_password" class="ml-2">Quên mật khẩu</label>
                                </a>
                            </div>
                            <!-- Button đăng nhập -->
                            <button type="submit" class="btn bg-main-yl py-3 d-flex align-items-center justify-content-center" onclick="lsRememberMe()">
                                <p class="fw-500">Đăng nhập</p>
                            </button>
                            <!-- Button Đăng ký -->
                            <a class="btn border-yl bg-transparent py-3 d-flex align-items-center justify-content-center" href="#">
                                <p class="fw-500">Tạo tài khoản</p>
                            </a>
                            @csrf
                        </form>
                    </div>
            ...
            <div class="col-7 rightSide">
                <img src="{{Themes::asset(user_setting("logoLoginPage"))}}" alt="Devitech Logo" width="455px" />
            </div>
        </div>
    </div>
    <!-- ./wrapper -->
