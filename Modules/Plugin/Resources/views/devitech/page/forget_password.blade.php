            ...
            <div class="col-5 leftSide">
                <div class="d-flex flex-column justify-content-between h-100">
                    <div style="flex-grow: 1" class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <form id="loginForm" action="{{route("admin.user.reset_password")}}" class="w-100 d-flex flex-column" style="gap: 19px" method="POST"  >
                            <div class="form-group">
                                <input type="text" class="form-control form-login" name="email" id="account" placeholder="Email" onchange="" />
                            ...
                            <button type="submit" class="btn bg-main-yl py-3 d-flex align-items-center justify-content-center" onclick="lsRememberMe()">
                                <p class="fw-500">Quên mật khẩu</p>
                            </button>
