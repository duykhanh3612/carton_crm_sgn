...
<head>
  ...
  <title>{{strtoupper(str_replace([".com",".info"],["",""], $_SERVER['SERVER_NAME']))}} | Log viewer</title>
  <link rel="stylesheet"
  ...
  <div class="row">
    <div class="col sidebar mb-3">
      ...
      <div class="custom-control custom-switch" style="padding-bottom:20px;">
        ...
        <a href="{{url('all-clear')}}" class="link f-right">Clear Cache</a>
      </div>
      <div class="action-log mb-4">
        @if($current_file)
