    ...
    <div class="col-md-{{$colLeft}}">
        <div class="form-group">
            ...
            <input
                ...
                @if(!empty($dataType)) data-type="{{ $dataType }}" @endif
                value="{{ $value!=""?$value:auth()->user()->id}}" @if(!empty($dataValue)) data-value="{{ $dataValue }}" @endif
                class="form-control auth {{ $class ?? '' }} @if($errors->has($name))is-invalid @endif"
                id="{{ $name }}"
                @if(!empty($inputData))
                ...
                <span class="form-control auth lock">{{user_name($value!=""?$value:auth()->user()->id)}}</span>
