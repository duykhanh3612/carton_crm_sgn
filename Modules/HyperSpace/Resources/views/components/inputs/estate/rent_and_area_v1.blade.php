...
<div class="form-group {{ $rowClass ?? 'col-md-12' }}"  id="list_rental_properties">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th  class="text-center" style="vertical-align: top;">Giá tổng <br><small>(USD)</small></th>
    ...
    <div class="col-md-4" id="form_rental_properties">
        ...
        {{-- @include('admin::components.inputs.text', ['type'=>'number', 'label'=>'Diện tích <small> (m<sup>2</sup>)</small>','name'=>'', 'class'=>'area input_money','rowClass'=>'nomargin',  'value'=> '',  'colLeft'=>6])
        @include('admin::components.inputs.text', ['label'=>'Lầu', 'name'=>'','class'=>'floor', 'value'=> '','rowClass'=>'nomargin',   'colLeft'=>6])
        @include('admin::components.inputs.select', ['label'=>'Đơn vị tính (USD/VNĐ)','name'=>'', 'data' =>  [1=>'USD',2=>'VNĐ'], 'class'=>'rent_type text-left','rowClass'=>'nomargin', 'value'=> '',  'colLeft'=>6])
        @include('admin::components.inputs.select', ['label'=>'Tính giá theo','name'=>'', 'data' =>  $rent_type, 'class'=>'rent_type text-left','rowClass'=>'nomargin', 'value'=> '',  'colLeft'=>6])
        @include('admin::components.inputs.text', ['type'=>'number','label'=>'Giá thuê <small>(USD)</small>','name'=>'', 'class'=>'total input_money','rowClass'=>'col-12', 'value'=> '',  'colLeft'=>12])
        @include('admin::components.inputs.text', ['type'=>'number','label'=>'Phí dịch vụ<small>(USD)</small>','name'=>'', 'dataValue' => @$record->fee_service, 'type'=>'number', 'class'=>'fee_service input_money','rowClass'=>'col-12', 'value'=> @$record->fee_service, 'colLeft'=>12])
        @include('admin::components.inputs.text', ['label'=>'Giá tổng <small>(VNĐ)</small>','name'=>'', 'class'=>'total_vnd input_money','rowClass'=>'nomargin', 'value'=> '',  'colLeft'=>6])
        @include('admin::components.inputs.text', ['label'=>'','type'=>'hidden','name'=>'', 'class'=>'rent_id', 'value'=> '',  'colLeft'=>12]) --}}
    ...
    <script>
        ...
        function calcSummary()
        {
            ...
            console.log(type,price,area, fee_service);
            if(type == 2)
            {
