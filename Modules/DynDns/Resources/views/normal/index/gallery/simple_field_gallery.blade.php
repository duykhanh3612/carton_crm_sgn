                        ...
                        <div class="col-md-{{@$col}} ctxdform image">
                            ...
                            <div class="col-md-12 lable_upload text-center">
                                ...
                                <div id="{{$ctrl->name}}thumb_upload{{@$item_image}}" class="thumb-output">
                                    @if(@$d->image!='')
                                    <a href="{{    url($base.@$d->image)}} " data-lightbox="roadtrip" data-title="<span style='float:left'>{{    @$d->title}}</span> <span style='float:right'><small> {{    @$d->content}}</small></span>" target="_blank">
