...
<div class="form-group col-md-2">
    <div class="form-group col-md-12">
        <label style="width:100%;">
            ...
            <select class="province_id form-control" {{@$ctrl->read==1 || $flg_read?"readonly disabled":"name=".$makert."[province_id]"}}>
    ...
    <div class="form-group col-md-12">
        <label style="width:100%;">
            ...
            {{Form::select($makert.'[district_id]', App\Model\Geo::getDistrictOptions(@$dm->province_id), @$dm->district_id, ['class'=>'district_id form-control']) }}
    </div>
    <div class="form-group col-md-12">
        <label style="width:100%;">
            Phường / Xã
        </label>
            {{Form::select($makert.'[ward_id]', App\Model\Geo::getDistrictOptions(@$dm->district_id), @$dm->ward_id, ['class'=>'ward_id form-control']) }}
    </div>
    <div class="form-group col-md-12">
        <label style="width:100%;">
            Đường
...
<div class="form-group col-md-7">
    <div class="form-group col-md-12">
        ...
        <div class="col-sm-12">
            <div class="input-group">
                <input id="google-input" name="{{$makert}}[formatted_address]" value="{{@$dm->formatted_address}}"  {{@$ctrl->read==1 || $flg_read?"readonly":""}} placeholder="Nhập Địa chỉ đầy đủ" autocomplete="off" type="text" class="form-control google-input">
                <div class="input-group-append">
                    <span id="btn_get_cookie" class="btn" style="cursor:pointer"><i class="fa fa-copy"></i></span>
    ...
    <div class="form-group col-md-12" id="panel_expand">
        ...
        <div class="col-sm-12">
            <div class="input-group">
                <input id="address-custom" name="{{$makert}}[formatted_address_custom]" value="{{@$dm->formatted_address_custom}}"  {{@$ctrl->read==1 || $flg_read?"readonly":""}} placeholder="Nhập Địa chỉ tùy chỉnh" autocomplete="off" type="text" class="form-control">
                <div class="input-group-append">
    ...
    <div class="row">
        <div class="form-group col-md-12 form-text">
            ...
            @php
                $latlng = "";
                if(!empty($dm->lat) && !empty($dm->lng)){
                    $latlng = $dm->lat.",".$dm->lng;
                }
            @endphp
            <input class="form-control" id="lat_lng"  {{@$ctrl->read==1 || $flg_read?"readonly":""}}  value="{{@$latlng }}" />
        </div>
        <div class="form-group col-md-6 form-text" >
            <label class="static-value">
                Vĩ độ:
            </label>
            <input class="form-control title has-value latitude" id="latitude" name="{{$makert}}[lat]" value="{{@$dm->lat}}" type="text" />
        </div>
        ...
        <div class="form-group col-md-6 form-text"  >
            ...
            <input class="form-control title has-value longitude" id="longitude" name="{{$makert}}[lng]" value="{{@$dm->lng}}" type="text" />
        </div>
        <div class="row col-md-6" style="padding-top:2px;" >
        ...
        <div class="form-group col-md-12 form-text">
            ...
            <div class="input-group">
                <input class="form-control" name="{{$makert}}[place_id]" id="place_id" {{@$ctrl->read==1 || $flg_read?"readonly":""}} value="{{@$dm->place_id}}" />
                <div class="input-group-append">
...
<script src="https://maps.googleapis.com/maps/api/js?key={{$conf->google_api}}&libraries=places" async defer></script>
<script>
