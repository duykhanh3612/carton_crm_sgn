                    ...
                    <div class="tab-pane {{ ( Session::get('active_tab') == 'infoTab' || Session::get('active_tab') =="") ? 'active' : '' }}" id="tab-1">
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group">
                                <label>
                                    {!!  trans('backLang.websiteTitle') !!}
                                     @if(Helper::GeneralWebmasterSettings("ar_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.arabicBox') !!}@endif
                                </label>
                                {!! Form::text('site_title_ar',$row->site_title_ar, array('placeholder' => trans('backLang.websiteTitle'),'class' => 'form-control', 'dir'=>trans('backLang.rtl'))) !!}
                            </div>
                            @endif
                            <div class="form-group">
                                <label>Title</label>
                                {!! Form::text('title_en',$row->title_en, array('placeholder' => trans('backLang.websiteTitle'),'class' => 'form-control', 'dir'=>trans('backLang.rtl'))) !!}
                            </div>
                            <div class="form-group">
                                <label>Content footer</label>
                                {!! Form::textarea('content_footer',$row->content_footer, array('placeholder' => trans('backLang.websiteTitle'),'class' => 'form-control', 'dir'=>trans('backLang.rtl'))) !!}
                            </div>
                            {!! view(_alias_admin.'::sys.template.normal.edit.seo.seo',array('row'=>$row,'ctrl'=>(object)array('name'=>'seo','value'=>'seo'))) !!}
                            ...
                            <!--@if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('site_title_en',$row->site_title_en, array('placeholder' => trans('backLang.websiteTitle'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("ar_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('site_desc_ar',$row->site_desc_ar, array('placeholder' => trans('backLang.metaDescription'),'class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'2')) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('site_desc_en',$row->site_desc_en, array('placeholder' => trans('backLang.metaDescription'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("ar_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('site_keywords_ar',$row->site_keywords_ar, array('placeholder' => trans('backLang.metaKeywords'),'class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'2')) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('site_keywords_en',$row->site_keywords_en, array('placeholder' => trans('backLang.metaKeywords'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                </div>
                            @endif-->
                        ...
                        <div class="p-a-md col-md-12">
                            @if(Helper::GeneralWebmasterSettings("ar_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_t1_ar',$row->contact_t1_ar, array('placeholder' => trans('backLang.contactAddress'),'class' => 'form-control', 'dir'=>trans('backLang.rtl'))) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_t1_en',$row->contact_t1_en, array('placeholder' => trans('backLang.contactAddress'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            @endif
                            <div class="form-group">
                            ...
                            @if(Helper::GeneralWebmasterSettings("ar_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_t7_ar',$row->contact_t7_ar, array('placeholder' => trans('backLang.worksTime'),'class' => 'form-control', 'dir'=>trans('backLang.rtl'))) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_t7_en',$row->contact_t7_en, array('placeholder' => trans('backLang.worksTime'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            @endif
                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'styleTab') ? 'active' : '' }}" id="tab-5">
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group row">
                                {!! view(_alias_admin.'::sys.template.normal.edit.image.image',array('row'=>$row,'ctrl'=>(object)array('title'=>'logo','name'=>'logo','value'=>'logo','mask'=>'default'),'func'=>$func)) !!}
                                ...
                                @if(Helper::GeneralWebmasterSettings("ar_box_status"))
                                    <div class="col-sm-6">
                                        ...
                                        @if($row->style_logo_ar!="")
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-12 box p-a-xs text-center">
                                                        <a target="_blank"
                                                           href="{{ URL::to('uploads/settings/'.$row->style_logo_ar) }}"><img
                                                                    src="{{ URL::to('uploads/settings/'.$row->style_logo_ar) }}"
                                                                    class="img-responsive" id="style_logo_ar_prv"
                                                                    style="width: auto;max-width: 260px;max-height: 60px">
                                                            <br>
                                                            <small>{{ $row->style_logo_ar }}</small>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                    <div class="col-sm-6">
                                        ...
                                        @if($row->style_logo_en!="")
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-12 box p-a-xs text-center">
                                                        <a target="_blank"
                                                           href="{{ URL::to('uploads/settings/'.$row->style_logo_en) }}"><img
                                                                    src="{{ URL::to('uploads/settings/'.$row->style_logo_en) }}"
                                                                    class="img-responsive" id="style_logo_en_prv"
                                                                    style="width: auto;max-width: 260px;max-height: 60px">
                                                            <br>
                                                            <small>{{ $row->style_logo_en }}</small>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if($row->style_fav!="")
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="col-sm-12 box p-a-xs text-center">
                                                    <a target="_blank"
                                                       href="{{ URL::to('uploads/settings/'.$row->style_fav) }}"><img
                                                                src="{{ URL::to('uploads/settings/'.$row->style_fav) }}"
                                    ...
                                    @if($row->style_apple!="")
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="col-sm-12 box p-a-xs text-center">
                                                    <a target="_blank"
                                                       href="{{ URL::to('uploads/settings/'.$row->style_apple) }}"><img
                                                                src="{{ URL::to('uploads/settings/'.$row->style_apple) }}"
                                            ...
                                            @if($row->style_bg_image!="")
                                                <div>
                                                    <div>
                                                        <div class="col-sm-12 box p-a-xs text-center">
                                                            <a target="_blank"
                                                               href="{{ URL::to('uploads/settings/'.$row->style_bg_image) }}"><img
                                            ...
                                            <div>
                                                <div>
                                                    <div id="footer_bg" class="col-sm-8 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ URL::to('uploads/settings/'.$row->style_footer_bg) }}"><img
