<td colspan="3">
    <table style="width:100%">
        ...
        <tr>
            <td class="section_e section_slider_image">
                ...
                <label><em>Hình ?nh</em> </label>
            </td>
            <td class="section_e section_slider_icon">
            ...
            <td class="section_e section_slider_icon_2">
                <label for="upload_icon_2{{$item_image}}" class="lable_upload_icon">
                    <input class="form-control row_icon item" value="{{@$d->icon_2}}" type="hidden" />
                    <div id="thumb_upload_icon_2{{$item_image}}" class="thumb-output_icon">
                        @if(@$d->icon_2!='')
                        <img src="{{url($base.@$d->icon_2)}}" />
                        @else
                        <img src="data:image/png;base64," />

                        @endif
                    </div>
                    <input type="file" id="upload_icon_2{{$item_image}}" data-id="#thumb_upload_icon_2{{    $item_image}}" style="display:none" class="add-file-upload_icon" />
                </label>
