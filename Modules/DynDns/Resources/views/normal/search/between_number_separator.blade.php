<div class="col-md-6 form-group last">
    ...
    <div class="col-md-10 input-group" style="float:left">
        ...
        <div class="col-md-6" style="padding-right:0px;">
            ...
            <input type="hidden" class="form-control md_line" id="money_{{ $ctrl->name }}_to" name="src[{{ $ctrl->name }}][between][to]" value="<?=@$src['to']?>" placeholder="{{__('lang.den')}}" />
        </div>


        <script src="{{base}}public/plugin/mask/jquery.mask.min.js" type="text/javascript"></script>
        ...
        $('.money_{{ $ctrl->name }}_from').on('change', function () {
            ...
            $('#money_{{ $ctrl->name }}_from').val(value);
        })
