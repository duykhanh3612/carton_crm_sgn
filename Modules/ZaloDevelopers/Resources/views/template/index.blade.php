                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->templateQuality}}</td>
                                    <td>{{$item->price}}</td>
                                    <td class="text-center">
                                        <a class="link-preview" href="  {{$item->previewUrl}}">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </td>
                                    <td class="d-flex">
                                        <button type="button" class="btn bg-main-yl text-nowrap link-process" data-href="{{route("zalo.zns.template.download.info",$item->templateId)}}">
                                            <i class="fa fa-download"></i>
                                            <p class="fw-500">Tải Info</p>
                                        </button>

                                        <button type="button" class="btn bg-main-yl text-nowrap link-process" data-href="{{route("zalo.zns.template.test",$item->templateId)}}">
                                            <i class="fa fa-download"></i>
                                            <p class="fw-500">Gửi data test</p>
                                        </button>
                                    </td>
                                </tr>
                                @endforeach
