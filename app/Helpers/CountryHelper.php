...
class CountryHelper
{
     ...
     * @return string|void
     */
    public static function nameToCode($country)
    {
        foreach (static::$_names as $code => $names) {
            foreach ($names as $name) {
                if (strtoupper($name) === strtoupper($country)) {
                    return $code;
                }
            }
        }
     ...
     * @return string|null
     */
    public static function codeToCode3($code)
    {
        return @static::$_alpha3Codes[$code];
    }
     ...
     * @return string|null
     */
    public static function codeToNumeric($code)
    {
        return @static::$_numericCodes[$code];
    }
     ...
     */
    public static function nameToCode3($country)
    {
        $code = static::nameToCode($country);
        if ($code) {
            return static::codeToCode3($code);
        }
    }
     ...
     * @return string|void|null
     */
    public static function nameToNumeric($country)
    {
        $code = static::nameToCode($country);
        if ($code) {
            return static::codeToNumeric($code);
        }
    }
     ...
     * @return string|void|null
     */
    public static function stateNameToCode($state , $countryCode = null){
        if($countryCode) {
            $states = @static::$_countryStates[$countryCode] ?? [];
            return static::getStateCode($states , $state);
        }
        else {
            foreach (static::$_countryStates as $countryCode => $states) {
                $code = static::getStateCode($states , $state);
                if($code) {
                    return $code;
                }
            }
     ...
     * @return string|null
     */
    private static function getStateCode($states , $state){
        foreach ($states as $code => $names) {
            foreach ($names as $name) {
                if(strtoupper($name) === strtoupper($state)) {
                    return $code;
                }
            }
        }
     ...
     * @return string|void|null
     */
    public static function stateCodeToName($stateCode , $countryCode = null){
        if($countryCode) {
            return @static::$_countryStates[$countryCode][$stateCode][0];
        }
        else {
            foreach (static::$_countryStates as $countryCode => $states) {
                if(!empty($states[$stateCode])) {
                    return @$states[$stateCode][0];
                }
            }
        }
    }
     ...
     * @return string|void
     */
    public static function searchCountryByStateCode($stateCode){
        foreach (static::$_countryStates as $countryCode => $states) {
